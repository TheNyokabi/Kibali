...
class BusinessContinuityPlansController extends SectionBaseController {
	...
	public function index($id = null) {
		$this->BusinessContinuityPlan->BusinessContinuityTask->bindNotifications();
	...
	private function handleEmptyDates() {
        if ($this->request->is(['post', 'put'])) {
            $this->request->data['BusinessContinuityPlanAuditDate'] = array_filter((array) $this->request->data['BusinessContinuityPlanAuditDate']);
        }
    }
	...
	private function updateFieldsWhenDesign() {
		...
		if ($this->request->data['BusinessContinuityPlan']['security_service_type_id'] == SECURITY_SERVICE_DESIGN) {
	...
	public function auditCalendarFormEntry() {
		...
		$this->set( 'model', 'BusinessContinuityPlanAuditDate' );
