...
class ErambaCalculation extends BaseCalculation {
	...
	public function __construct() {
		...
		$this->name = 'Eramba';
		$this->description = __('Eramba ships with a default risk calculation that takes in consideration the risk classification and the liabilities to which each asset, third party or business process is subject. It does not take in consideration Asset Classification.');
		$this->settings = array();
