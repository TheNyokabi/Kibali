			...
			<div class="widget-content">
				...
				<div class="tabbable box-tabs box-tabs-styled">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_custom_roles" data-toggle="tab"><?php echo __('Custom Roles'); ?></a></li>
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade in" id="tab_custom_roles">
							<?php
							echo $this->Ux->getAlert(__('General fields that includes Custom Role functionality.'), ['type' => 'info']);

							echo $this->FieldData->inputs([
								$FieldDataCollection->custom_role_id
							]);
							?>
						</div>
