...
class SectionItem extends SectionBase {
	...
	public function __construct($id = false, $table = null, $ds = null) {
		...
		$this->fieldData = array(
			...
			'toggle_status' => array(
				'label' => __('Toggle Checkbox'),
				'editable' => true,
				'type' => 'toggle',
				'description' => __('Enabled')
			),
			'custom_role_id' => array(
				'label' => __('Custom Role (BelongsTo)'),
				'editable' => true,
				'description' => __('Testing description'),
				'empty' => __('Select a user'),
		...
		$this->importArgs = array(
            'SectionItem.varchar' => array(
                'name' => __('Varchar')
            ),
            'SectionItem.text' => array(
                'name' => __('Text')
            ),
            'SectionItem.date' => array(
            	'name' => __('Date'),
            ),
            'SectionItem.user_id' => array(
                'name' => __('BelongsTo'),
                'model' => 'BelongsTo',
            ),
            'SectionItem.HasAndBelongsToMany' => array(
