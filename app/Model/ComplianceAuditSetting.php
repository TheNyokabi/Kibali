...
class ComplianceAuditSetting extends SectionBase implements InheritanceInterface {
	...
	public $hasMany = array(
		...
		'Attachment' => array(
			...
			'conditions' => array(
				'Attachment.model' => 'ComplianceAuditSetting'
			)
		),
		'Comment' => array(
			'className' => 'Comment',
			'foreignKey' => 'foreign_key',
			'conditions' => array(
				'Comment.model' => 'ComplianceAuditSetting'
			)
		),
		'SystemRecord' => array(
			...
			'foreignKey' => 'foreign_key',
			'conditions' => array(
				'SystemRecord.model' => 'ComplianceAuditSetting'
			)
		)
	);
