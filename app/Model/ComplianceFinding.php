...
class ComplianceFinding extends SectionBase implements InheritanceInterface {
	...
	public $hasMany = array(
		'Attachment' => array(
			...
			'conditions' => array(
				'Attachment.model' => 'ComplianceFinding'
			)
		),
		'Comment' => array(
			'className' => 'Comment',
			'foreignKey' => 'foreign_key',
			'conditions' => array(
				'Comment.model' => 'ComplianceFinding'
			)
		),
		'SystemRecord' => array(
			...
			'foreignKey' => 'foreign_key',
			'conditions' => array(
				'SystemRecord.model' => 'ComplianceFinding'
			)
		),
		'NotificationObject' => array(
			...
			'foreignKey' => 'foreign_key',
			'conditions' => array(
				'NotificationObject.model' => 'ComplianceFinding'
			)
		),
    ...
    public function statusExpired($conditions = null) {
        return parent::statusExpired([
            'ComplianceFinding.deadline < NOW()'
        ]);
    }
