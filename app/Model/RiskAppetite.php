	...
	public function __construct($id = false, $table = null, $ds = null) {
		...
		$this->fieldData = [
			...
			'RiskClassificationType' => [
				...
				'editable' => true,
				'description' => __('Select two (not more or less) risk classification settings which will be used to define risk thresholds.'),
	...
	public function beforeValidate($options = array()) {
		if ($this->data['RiskAppetite']['method'] == RiskAppetite::TYPE_THRESHOLD) {
			...
			$this->validator()->add('RiskClassificationType', 'count', array(
				...
				'message' => __('Your have to enter exactly %d classification types', self::REQUIRED_COUNT)
			));
