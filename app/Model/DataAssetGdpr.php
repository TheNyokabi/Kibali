...
class DataAssetGdpr extends SectionBase {
    ...
    public static $fieldGroups = [
        DataAsset::STATUS_COLLECTED => [
            'DataAssetGdprDataType', 'purpose', 'right_to_be_informed', 'data_subject', 'DataAssetGdprCollectionMethod', 'volume', 'recived_data', 'DataAssetGdprLawfulBase', 'contracts',
        ],
        DataAsset::STATUS_MODIFIED => [
            'stakeholders', 'accuracy', 'right_to_access', 'right_to_rectification', 'right_to_decision', 'right_to_object'
        ],
        DataAsset::STATUS_STORED => [
            'retention', 'encryption', 'right_to_erasure', 'DataAssetGdprArchivingDriver'
        ],
        DataAsset::STATUS_TRANSIT => [
            'origin', 'destination', 'transfer_outside_eea', 'ThirdPartyInvolved', 'DataAssetGdprThirdPartyCountry', 'security', 'right_to_portability',
        ],
        DataAsset::STATUS_DELETED => [
        ],
    ];
