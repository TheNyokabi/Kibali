...
if ($classificationTypeCount >= 2) {
	...
	$thresholdWrapper = $this->element('../RiskAppetites/threshold_item', [
		'FieldDataCollection' => $FieldDataThresholdCollection,
		'isDefault' => true,
	...
	echo __('More than one classification type must have been defined for this option to be available, otherwise display “This setting can not be used until you define more than one Risk Classification Type"');
}
?>
