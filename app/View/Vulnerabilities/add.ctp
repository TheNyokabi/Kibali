	...
	<div class="col-md-12">
		<div class="widget box widget-form">
			...
			<div class="widget-content">
				...
				<?php
					echo $this->Form->create( 'Vulnerability', array(
						'url' => array( 'controller' => 'vulnerabilities', 'action' => 'add' ),
								...
								<div class="col-md-10">
									<?php echo $this->Form->input( 'name', array(
										...
										'error' => array(
											...
											'unique' 	=> __('Same vulnerability already exists.'),
										)
									) ); ?>
									<span class="help-block"><?php echo __( 'Give a name to this vulnerability' ); ?></span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="form-actions">
					...
					&nbsp;
					<?php
					echo $this->Ajax->cancelBtn('Vulnerability');
					?>
				</div>
