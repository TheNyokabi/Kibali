		...
		<div class="body">
			...
			<div class="item">
				<table>
					...
					<tr>
						<td>
							<?php echo $item['Risk']['description']; ?>
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="item">
				<table class="double-column">
					...
					<tr>
						<td>
							<?php echo $this->Risks->getStatuses($item, 'Risk', true); ?>
						</td>
						<td>
							<?php echo $item['Risk']['review']; ?>
						</td>
					</tr>
				</table>
			</div>
		...
		<div class="body">
			...
			<div class="item">
				<table>
					...
					<tr>
						<td>
							<?php echo nl2br($item['Risk']['threats']); ?>
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="item">
				<table>
					...
					<tr>
						<td>
							<?php echo nl2br($item['Risk']['vulnerabilities']); ?>
						</td>
					</tr>
				</table>
			</div>
