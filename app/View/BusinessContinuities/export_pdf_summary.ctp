					...
					<table class="table-pdf table-pdf-system-records" style="">
						...
						<tbody>
							<?php foreach ($items as $item) : ?>
								<tr>
									<td><?php echo $item['BusinessContinuity']['title']; ?></td>
									<td><?= $this->UserField->showUserFieldRecords($item['Stakeholder']); ?></td>
									<td><?php echo $item['RiskMitigationStrategy']['name']; ?></td>
									<td><?php echo $item['BusinessContinuity']['risk_score']; ?></td>
									<td><?php echo $item['BusinessContinuity']['residual_risk']; ?></td>
									<td><?php echo $item['BusinessContinuity']['review']; ?></td>
									<td>
										<?php
										echo $this->Risks->getStatuses($item, 'BusinessContinuity', true);
										?>
									</td>
								</tr>
							<?php endforeach; ?>
