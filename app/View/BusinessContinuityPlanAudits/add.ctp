<div class="row">
		...
		<div class="widget box widget-form">
			...
			<div class="widget-content">
				...
				<div class="form-actions">
					...
					&nbsp;
					<?php
					echo $this->Ajax->cancelBtn('BusinessContinuityPlanAudit', isset($edit) ? $this->data['BusinessContinuityPlanAudit']['id'] : null);
					?>
				</div>
	...
	<div class="col-lg-5">
		...
		echo $this->element('ajax-ui/sidebarWidget', array(
			...
			'id' => isset($edit) ? $this->data['BusinessContinuityPlanAudit']['id'] : null
		));
		?>
	</div>
</div>